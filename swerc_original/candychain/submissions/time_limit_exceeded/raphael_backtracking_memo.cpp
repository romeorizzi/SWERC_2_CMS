// Dynamic programming solution for Candy Chain, but based on the
// remaining strings. There is an exponential number of them in the
// worst case, and this code should also time out.
...
std::unordered_map<std::string, int> dyna;
